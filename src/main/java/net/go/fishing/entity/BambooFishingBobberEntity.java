package net.go.fishing.entity;

import it.unimi.dsi.fastutil.objects.ObjectArrayList;
import net.go.fishing.item.ModItems;
import net.go.fishing.mixin.FishingBobberAccessor;
...
public class BambooFishingBobberEntity /*extends FishingBobberEntity*/ {
    ...
    public int use(ItemStack usedItem) {
        ...
        if (this.getHookedEntity() != null) {
            ...
            pool.add(new ItemWithWeight(new ItemStack(ModItems.RAW_GREEDILY_FISH), 25));
            pool.add(new ItemWithWeight(new ItemStack(ModItems.RED_CARD_FISH), 25));
            pool.add(new ItemWithWeight(new ItemStack(ModItems.BLACK_CARD_FISH), 25));
            // TODO ADD MORE FISH
